...
(function () {
  ...
  var PYCODE = [
    ...
    "si=[SII[k] for k in ['original','static','wdrc','rx','nal','dsl','per']]",
    "st=[STOI[k] for k in ['original','static','wdrc','rx','nal','dsl','per']]",
    "er=[ERR[k] for k in ['original','static','wdrc','rx','nal','dsl','per']]"
  ].join("\n");
